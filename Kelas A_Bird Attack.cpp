...
char audiofile[] = {"C:/Users/raiha/OneDrive/Documents/dev c++/Project Game/gameover.wav"};
	string audiofile2;
	
char burung[] = {"C:/Users/raiha/OneDrive/Documents/dev c++/Project Game/burung.wav"};
	string burung2;
	
char click[] = {"C:/Users/raiha/OneDrive/Documents/dev c++/Project Game/click.wav"};
	string click2;

char start[] = {"C:/Users/raiha/OneDrive/Documents/dev c++/Project Game/start.wav"};
	string start2;
...
void clicksound(){
		fp.open(click, ios::in);
		click2 = click;
		PlaySound(click2.c_str(), NULL, SND_ASYNC);
		fp.close();
}
...
void draw(){
	...
	clicksound();
	Sleep(50);
	fp.open(start, ios::in);
	start2 = start;
	PlaySound(start2.c_str(), NULL, SND_ASYNC);
	fp.close();
...
bool coll(int ind){
	for(int i=0; i<4; i++){
	if(enemyposx[ind] - posbullx[i] >= 0 && enemyposx[ind] - posbullx[i] < 2 && enemyposy[ind] - posbully[i] == 0){
		if (enemyposy[ind] - posbully[i] >= 0 && enemyposy[ind] - posbully[i] < 2){
			resetbullet(i);
			resetenemy(ind);
			
			fp.open(burung, ios::in);
			burung2 = burung;
			PlaySound(burung2.c_str(), NULL, SND_ASYNC);
			fp.close();
